...
local spec_types = {
  models = function(name)
    return [[import use_test_env from require "kong-lapis.spec"
import truncate_tables from require "kong-lapis.spec.db"
...
describe "]] .. name .. [[", ->
  ...
  applications = function(name)
    return [[import use_test_server from require "kong-lapis.spec"
