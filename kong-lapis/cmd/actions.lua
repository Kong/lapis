...
do
  local _obj_0 = require("kong-lapis.cmd.util")
...
do
  ...
  local _base_0 = {
    ...
    get_server_module = function(self)
      return require("kong-lapis.cmd." .. tostring(self:get_server_type()))
    end,
    get_server_actions = function(self)
      return require("kong-lapis.cmd." .. tostring(self:get_server_type()) .. ".actions")
    end,
    ...
    get_action = function(self, name)
      ...
      local action
      pcall(function()
        action = require("kong-lapis.cmd.actions." .. tostring(name))
      end)
      return action
    end,
    actions = {
      {
        ...
        function(self, flags)
          ...
          if flags.cqueues then
            server_actions = require("kong-lapis.cmd.cqueues.actions")
          else
            server_actions = require("kong-lapis.cmd.nginx.actions")
          end
          server_actions.new(self, flags)
          if flags.lua then
            self:write_file_safe("app.lua", require("kong-lapis.cmd.templates.app_lua"))
            self:write_file_safe("models.lua", require("kong-lapis.cmd.templates.models_lua"))
          else
            self:write_file_safe("app.moon", require("kong-lapis.cmd.templates.app"))
            self:write_file_safe("models.moon", require("kong-lapis.cmd.templates.models"))
          end
          if flags.git then
            self:write_file_safe(".gitignore", require("kong-lapis.cmd.templates.gitignore")(flags))
          end
          if flags.tup then
            local tup_files = require("kong-lapis.cmd.templates.tup")
      ...
      },
      {
        ...
        function(self, flags, environment)
          ...
          write_config_for = require("kong-lapis.cmd.nginx").write_config_for
          write_config_for(environment)
          local send_hup
          send_hup = require("kong-lapis.cmd.nginx").send_hup
          local pid = send_hup()
          if pid then
      ...
      },
      {
        ...
        function(self)
          local send_term
          send_term = require("kong-lapis.cmd.nginx").send_term
          local pid = send_term()
          if pid then
      ...
      },
      {
        ...
        function(self, flags, signal)
          ...
          local send_signal
          send_signal = require("kong-lapis.cmd.nginx").send_signal
      ...
      },
      {
        ...
        function(self, flags, code, environment)
          ...
          do
            local _obj_0 = require("kong-lapis.cmd.nginx")
      ...
      },
      {
        ...
        function(self, flags, environment)
          ...
          local env = require("kong-lapis.environment")
      ...
      },
      {
        ...
        function(self, flags, template_name, ...)
          ...
          if not (tpl) then
            tpl = require("kong-lapis.cmd.templates." .. tostring(template_name))
          end
      ...
      },
      {
        ...
        help = "show this text",
        function(self)
          print(colors("Lapis " .. tostring(require("kong-lapis.version"))))
          print("usage: lapis <action> [arguments]")
          local find_nginx
          find_nginx = require("kong-lapis.cmd.nginx").find_nginx
  ...
  _class_0 = setmetatable({
    __init = function(self)
      self.path = require("kong-lapis.cmd.path")
