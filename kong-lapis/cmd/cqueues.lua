...
do
  ...
  local _base_0 = {
    attach_server = function(self, env, overrides)
      ...
      AttachedServer = require("kong-lapis.cmd.cqueues.attached_server").AttachedServer
...
do
  ...
  local _base_0 = {
    ...
    start = function(self)
      ...
      package.loaded["kong-lapis.running_server"] = "cqueues"
      assert(self.server:loop())
      package.loaded["kong-lapis.running_server"] = nil
    end
  }
  _base_0.__index = _base_0
  _class_0 = setmetatable({
...
create_server = function(app_module)
  ...
  local dispatch
  dispatch = require("kong-lapis.cqueues").dispatch
  local load_app
  load_app = function()
    local app_cls
