...
use_db_connection = ->
  ...
  setup ->
    import connect from require "kong-lapis.db"
    connect! if connect

  teardown ->
    import disconnect from require "kong-lapis.db"
...
use_test_server = ->
  import setup, teardown from require "busted"
  import load_test_server, close_test_server from require "kong-lapis.spec.server"
