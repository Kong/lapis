...
OffsetPaginator = require("kong-lapis.db.pagination").OffsetPaginator
local add_relations, mark_loaded_relations
do
  local _obj_0 = require("kong-lapis.db.model.relations")
...
do
  ...
  local _base_0 = {
    ...
    refresh = function(self, fields, ...)
      ...
      if field_names then
        ...
        local relations = require("kong-lapis.db.model.relations")
        do
  ...
  self.extend = function(self, table_name, tbl)
    ...
    local lua = require("kong-lapis.lua")
    local class_fields = {
      "primary_key",
      "timestamp",
      "constraints",
