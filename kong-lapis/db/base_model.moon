import underscore, escape_pattern, uniquify, singularize from require "kong-lapis.util"
...
import OffsetPaginator from require "kong-lapis.db.pagination"
import add_relations, mark_loaded_relations from require "kong-lapis.db.model.relations"
...
class BaseModel
  ...
  refresh: (fields="*", ...) =>
    ...
    if field_names
      ...
      relations = require "kong-lapis.db.model.relations"
