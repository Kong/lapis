local logger = require("kong-lapis.logging")
local lapis_config = require("kong-lapis.config")
local Router
Router = require("kong-lapis.router").Router
local insert
insert = table.insert
...
do
  local _class_0
  local _base_0 = {
    Request = require("kong-lapis.request"),
    layout = require("kong-lapis.views.layout"),
    error_page = require("kong-lapis.views.error"),
    views_prefix = "views",
    flows_prefix = "flows",
    enable = function(self, feature)
      local fn = require("kong-lapis.features." .. tostring(feature))
