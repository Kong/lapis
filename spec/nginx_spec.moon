...
ngx_stack = require "kong-lapis.spec.stack"

describe "nginx.context", ->
  before_each ->
    package.loaded["kong-lapis.nginx.context"] = nil
    ngx_stack.push { ctx: {} }
  ...
  it "should run no callbacks", ->
    import run_after_dispatch from require "kong-lapis.nginx.context"
    run_after_dispatch!

  it "should run one callback", ->
    import run_after_dispatch, after_dispatch from require "kong-lapis.nginx.context"
  ...
  it "should run multiple callbacks", ->
    import after_dispatch, run_after_dispatch from require "kong-lapis.nginx.context"
